...
# Il firmware conta su CHANGE (entrambi i fronti di A e B).
# Valore CONFERMATO dal firmware: const long TICKS_PER_360 = 1200
# (hardcoded in esp32_motori_ottimizzato.ino, riga 158)
TICKS_PER_REV = 1200          # CONFERMATO dal firmware ESP32
